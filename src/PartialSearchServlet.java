...
public class PartialSearchServlet extends LoginBaseServlet {

	private static final String TITLE = "Partial Search";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			out.printf("<h1 align=\"center\">Search Engine</h1>%n%n");

			out.printf("<form action =\"searchresults\">%n");
			out.printf("<input type=\"text\" name=\"query\"><br>");
			out.printf("\t<button name = \"Partial\" type=\"submit\">Search</button>%n");
			out.printf("</form>%n");
